  ...
  render() {
    return (
      <div className="center">
        <a
          href="https://github.com/BrunoRoque06"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/BrunoRoque06"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
        ...
        <a
          href="documents/BrunoRoqueCv.pdf"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
          ...
          >
            <g>
              <path
                d="M235.143,17.081H17.5c-9.649,0-17.5,7.851-17.5,17.5v147.658c0,9.649,7.851,17.5,17.5,17.5h126.911
		...
		c1.355,0,2.5,1.145,2.5,2.5V182.239z"
              />
              <path
                d="M208.619,60.243h-170c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h170
		c4.143,0,7.5-3.357,7.5-7.5C216.119,63.6,212.762,60.243,208.619,60.243z"
              />
              <path
                d="M110.619,100.911h-72c-4.143,0-7.5,3.357-7.5,7.5c0,4.143,3.357,7.5,7.5,7.5h72
		c4.143,0,7.5-3.357,7.5-7.5C118.119,104.268,114.762,100.911,110.619,100.911z"
              />
            </g>
          </svg>
        </a>
